...
export declare class AddresseService {
    private Usermodel;
    ...
    updateAddresse(body: UpdateAddresseDto, addresseId: mongodbId, user: UserDoc): Promise<{
        addresses: {
            _id: import("mongoose").Schema.Types.ObjectId;
            postalCode: number;
            details: string;
    ...
    deleteAddresse(addresseId: mongodbId, user: UserDoc): Promise<{
        addresses: {
            _id: import("mongoose").Schema.Types.ObjectId;
            postalCode: number;
            details: string;
